// Overlay Authentication Handler
// Handles login, logout, and profile dashboard display
...
/**
 * Show purchase history (popup version)
 */
viewHistoryBtn.addEventListener('click', () => {
  alert('Full purchase history available in the main dashboard');
  openDashboardBtn.click();
});

/**
 * Show chat history (popup version)
 */
viewChatsBtn.addEventListener('click', () => {
  alert('Full chat history available in the main dashboard');
  openDashboardBtn.click();
});
...
console.log('Overlay auth initialized');
